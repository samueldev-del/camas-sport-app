...
const FR = {
  ...
  auth_birth_date_ph:'jj.mm.aaaa',
  auth_birth_date_invalid:'Entre une date valide au format jj.mm.aaaa.',
  auth_age:         'Âge',
  auth_email:       'Email',
  ...
  auth_profile_edit_title:'Mettre à jour mes informations',
  auth_profile_edit_intro:'Corrige ton identité joueur et garde ton profil prêt pour les prochains dimanches.',
  auth_profile_save:'Enregistrer mon profil',
  auth_profile_tracking_title:'Fiche de suivi',
  auth_profile_tracking_intro:'Retrouve ici tes repères de saison et ton activité avec le groupe.',
  auth_profile_tracking_loading:'Chargement de ta fiche de suivi…',
  auth_profile_stat_goals:'Buts',
  auth_profile_stat_assists:'Passes',
  auth_profile_stat_presence:'Présences',
  auth_profile_stat_punctuality:'Ponctualité',
  auth_profile_stat_motm:'MotM',
  ...
  auth_visual_title:'Prépare tes crampons, ton dimanche t’attend',
  auth_visual_sub:  'Entre dans le groupe, bloque ta place pour le prochain match et ramène ton énergie sur le terrain CAMAS.',
  auth_visual_fast: 'Vestiaire prêt',
  auth_visual_presence:'Place verrouillée',
  auth_visual_motm: 'Mental de match',
  ...
  players_positions_ready:'Postes déclarés',
  player_internal_rating:'Note interne',
  add_btn:          '+ Ajouter',
  ...
  admin_users_title:       'Inscriptions complètes des joueurs',
  admin_users_empty:       'Aucune inscription disponible.',
  admin_users_status_registered: 'Compte actif',
  admin_users_status_not_registered: 'Compte révoqué',
  admin_revoke_btn:        'Révoquer inscription',
  admin_revoke_confirm:    'Révoquer cette inscription joueur ? Cette action déconnectera le compte.',
  admin_revoke_ok:         'Inscription joueur révoquée',
  admin_stats_revoke:      'Révoquer présence',
  admin_stats_revoke_confirm: 'Révoquer la présence de ce joueur pour le match courant ?',
  admin_stats_revoke_ok:   'Présence révoquée',
...
const DE = {
  ...
  auth_birth_date_ph:'tt.mm.jjjj',
  auth_birth_date_invalid:'Gib ein gültiges Datum im Format tt.mm.jjjj ein.',
  auth_age:         'Alter',
  auth_email:       'E-Mail',
  auth_phone:       'Telefon',
  ...
  auth_profile_edit_title:'Meine Daten aktualisieren',
  auth_profile_edit_intro:'Halte deine Spielerinfos sauber, damit dein Profil für die nächsten Sonntage bereit ist.',
  auth_profile_save:'Profil speichern',
  auth_profile_tracking_title:'Mein Steckbrief',
  auth_profile_tracking_intro:'Hier findest du deine Saisonwerte und deinen Verlauf mit dem Team.',
  auth_profile_tracking_loading:'Dein Steckbrief wird geladen…',
  auth_profile_stat_goals:'Tore',
  auth_profile_stat_assists:'Assists',
  auth_profile_stat_presence:'Anwesenheiten',
  auth_profile_stat_punctuality:'Pünktlichkeit',
  auth_profile_stat_motm:'MotM',
  ...
  auth_visual_title:'Schnür die Schuhe, dein Sonntag ruft',
  auth_visual_sub:  'Komm in den Kader, sichere dir deinen Platz für das nächste Spiel und bring sofort Energie auf den CAMAS-Platz.',
  auth_visual_fast: 'Kabine bereit',
  auth_visual_presence:'Platz gesichert',
  auth_visual_motm: 'Match-Mentalität',
  ...
  players_positions_ready:'Gemeldete Positionen',
  player_internal_rating:'Interne Note',
  add_btn:          '+ Hinzufügen',
  ...
  admin_save_btn:          'Speichern',
  admin_users_title:       'Vollständige Spieler-Anmeldungen',
  admin_users_empty:       'Keine Anmeldungen verfügbar.',
  admin_users_status_registered: 'Konto aktiv',
  admin_users_status_not_registered: 'Konto widerrufen',
  admin_revoke_btn:        'Anmeldung widerrufen',
  admin_revoke_confirm:    'Diese Spieler-Anmeldung widerrufen? Das Konto wird abgemeldet.',
  admin_revoke_ok:         'Spieler-Anmeldung widerrufen',
  admin_stats_revoke:      'Teilnahme widerrufen',
  admin_stats_revoke_confirm: 'Teilnahme dieses Spielers für das aktuelle Spiel widerrufen?',
  admin_stats_revoke_ok:   'Teilnahme widerrufen',
